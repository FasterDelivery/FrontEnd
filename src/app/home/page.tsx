...
export default function Home(){
    return(
        ...
        <button type="button" className=" my-4 text-white bg-[#217BCE] hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-md text-sm px-5 py-2.5 max-w-md w-screen">OBTENER PAQUETES</button>
            ...
            <div className="">
                <div className="flex flex-col justify-between h-full">
                    <div className="flex justify-between">
                     <p className="font-sans text-sm mr-8"> Amenabar 2356, CABA</p>
                     <Image src={trash} alt="trash" width={16} height={16} />
                    </div>
                    <p className="font-sans text-sm font-bold self-end">Entregado</p>
                </div>
            </div>
        </div>
        <div className="flex justify-between py-4 h-110px w-full">
            ...
            <div className="">
                <div className="flex flex-col justify-between h-full">
                    <div className="flex justify-between">
                     <p className="font-sans text-sm mr-8"> Av. Carabobo y Rivadavia, CABA</p>
                     <Image src={trash} alt="trash" width={16} height={16}/>
                    </div>
                    <p className="font-sans text-sm font-bold self-end">Entregado</p>
                </div>
        ...
        <div className="flex justify-between py-4 h-110px w-full">
            ...
            <div className="">
                <div className="flex flex-col justify-between h-full">
                    ...
                    <p className="font-sans text-sm font-bold self-end text-yellow-300">En curso</p>
                </div>
            </div>
        </div>
        </div>
